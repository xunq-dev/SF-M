...
export function RenameTabPopup({ value, onChange, onOk, onCancel }: RenameTabPopupProps) {
  return (
    <div className="relative w-[384px] h-[203px] z-50 drop-shadow-2xl animate-in fade-in zoom-in-95 duration-150" data-name="Rename Tab Popup" data-v3-rename-popup-root>
      ...
      <div 
        onClick={onOk}
        className="absolute left-[240px] top-[154px] w-[50px] h-[32px] bg-[#373737] border border-[#3f3f3f] border-solid rounded-[4px] cursor-pointer hover:bg-[#4a4a4a] flex items-center justify-center select-none"
      >
      ...
      <p className="absolute font-['Inter',sans-serif] font-normal leading-[normal] left-[50px] not-italic text-[20px] text-white top-[17px] whitespace-nowrap">Rename tab</p>
      <p className="absolute font-['Inter',sans-serif] font-normal leading-[normal] left-[50px] not-italic text-[16px] text-white top-[54px] whitespace-nowrap">Input the new tab name below.</p>
